...
module.exports = {
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: "host",
      remotes: {
        trackEditor: "trackEditor@http://localhost:3001/remoteEntry.js",
        instruments: "instruments@http://localhost:3003/remoteEntry.js",
        plugins: "plugins@http://localhost:3002/remoteEntry.js",
        collaboration: "collaboration@http://localhost:3005/remoteEntry.js",
      },
      shared: {
